...
fpm \
  ...
  --depends python2.6 --depends python-boto --depends python-click --depends python-networkx --depends python-ordereddict --depends python-yaml -s python -t deb setup.py
...
fpm \
  ...
  --python-install-bin '/usr/bin' --no-python-dependencies \
  --depends 'python>=2.6' --depends python-boto --depends python-click --depends python-networkx --depends python-ordereddict --depends python-yaml -s python -t rpm setup.py
